...
<ErrorText>An error occurred (AccessDenied) when calling the ListConflictingAliases operation: User: arn:aws:iam::1231456:user/kwangmin-aws-serverless is not authorized to perform: cloudfront:ListConflictingAliases on resource: arn:aws:cloudfront::886436946542:distribution/E157FEJO2A2BXR because no identity-based policy allows the cloudfront:ListConflictingAliases action</ErrorText>
